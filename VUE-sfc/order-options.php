        ...
        <div class="oo-wrap">
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div id="mealPlanOptions" class="option-cat d-flex flex-column flex-md-row justify-content-between mb-4-5">
                        <p class="option-title  tk-korolev fw-700 justify-content-between d-flex flex-md-column mb-2-5">Meal Plan 
                    ...
                    <div id="deliveryOptions">
                        <div class="auto-d-wrap">
                            ...
                            <div class="btn-wrap mb-4">
                                ...
                                @click="selectPrepay('autoDelivery'), changePricePerMeal(4.64)" 
                                ...
                                <div class="prepay d-flex flex-column">
                                    ...
                                    @click="selectPrepay('bogo'), changePricePerMeal(4.18)" name="delivery"  
                                    aria-pressed="false" >
                                    ...
                                    class="mb-3"
                                    :aria-pressed="selectedPrepay === 'pre3pay'" @click="selectPrepay('pre3pay'), changePricePerMeal(3.95)" name="delivery"  aria-pressed="false" >
                                    ...
                                    class=""
                                    :aria-pressed="selectedPrepay === 'pre4pay'" @click="selectPrepay('pre4pay'), changePricePerMeal(3.85)" name="delivery"  aria-pressed="true" >
...
<!--add shakes-->
                    <div id="addShakes" class="card p-3 mb-3 gap-3">
                        ...
                        <div class="shake-checkbox d-flex gap-3">
                            <input type="checkbox" name="shakes-added" id="shakesAdded" data-bs-toggle="collapse" href="#flavorSelect" aria-checked="false"> 
                        ...
                        <div id="flavorSelect" class="collapse" aria-expanded="false">
